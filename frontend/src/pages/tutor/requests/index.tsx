...
import { RequestDetailsRow } from '../../../components/feature/RequestDetailsRow';
    ...
    <div className="text-gray-600 antialiased">
      ...
      <Section yPadding="pt-10 pb-32">
        <div className="mb-8 text-left">
          <h2 className="text-4xl font-bold text-gray-900">Requests</h2>
          <div className=" text-xl">View Appointment Requests</div>
        </div>

          {data.map(item => (
            <RequestDetailsRow key={item.id} name={item.name} desc={item.description} mod={item.mod} date={item.date} time={item.time}/>
